  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-270">
        <Breadcrumb pageName="modifier son profile" />
                  ...
                  >
                    ...
                    {imagePreview ?
                      ...
                      <div className="flex flex-col items-center justify-center space-y-3">
                        <img src={imagePreview} alt="User" className="w-full h-full object-contain object-center" />
                      </div>
                      ) :
                      (
                        <div className="flex flex-col items-center justify-center space-y-3">
